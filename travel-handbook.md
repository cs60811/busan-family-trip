...
依類別分組，之後會加入食品類伴手禮。以下 7 樣目前都查過，**全部在 OLIVE YOUNG 買得到**，不用特地找專門店；Fwee、Torriden、UNOVE、Longtake 這幾個小眾品牌建議挑大一點的分店才貨齊（見下方「行程沿路的大型分店」，這 4 間都已經是規模較大的）。
...
**行程沿路的大型分店**（規模較大，貨較齊，以上 7 樣都可以在下面任一間買齊）：
